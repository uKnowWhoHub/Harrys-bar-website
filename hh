Here is your full HTML script with animations added for fade-ins and button hover effects. You can copy and paste this into an .html file and open it in any browser:
...
<script>
  ...
  function returnToEmployeeScreen() {
    ...
    const employee = document.getElementById("employee-select");
    employee.classList.remove("hidden");
    employee.classList.add("fade-in");
  }
  ...
  function payTab() {
    ...
    const modal = document.getElementById("pay-summary");
  ...
  function showPaidTabs() {
    document.getElementById("home").classList.add("hidden");
    const paid = document.getElementById("paid-tabs");
    paid.classList.remove("hidden");
    paid.classList.add("fade-in");
...
Let me know if you’d like slide-in transitions, dark mode toggle, or animations for individual items appearing in the list.
